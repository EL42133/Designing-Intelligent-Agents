...
class Warehouse(gym.Env):
    ...
    def __init__(
        ...
        #####
        self.num_high_priority = num_high_priority
    ...
    def reset(self, seed=None, options=None):
        ...
        #####
        high_priority_shelves = self.np_random.choice(
            self.request_queue, size=self.num_high_priority, replace=False
        )

        for shelf in self.request_queue:
            shelf.priority = self.priority_level if shelf in high_priority_shelves else 0
        #####
